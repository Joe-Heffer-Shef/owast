...
def get_service_client(conn_str: str = None, *args, **kwargs) -> azure.storage.blob.BlobServiceClient:
    conn_str = conn_str or CONN_STR
    return azure.storage.blob.BlobServiceClient.from_connection_string(conn_str=conn_str, *args, **kwargs)
